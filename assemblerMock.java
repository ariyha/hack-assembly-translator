...
import java.util.*;
		...
		class Parser extends SymbolTable
		{
		    ...
		    void input(String infile)throws IOException
		    {
		        ...
		        FileReader in = new FileReader(infile);
		        BufferedReader inF  = new BufferedReader(in); 
		        FileWriter out = new FileWriter("C:\\Users\\manas\\OneDrive\\Desktop\\nand2tetris\\projects\\06\\max\\Max.hack");
...
public class assemblerMock {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		        
		        Parser obj1 = new Parser();
		        
		        String path = "C:\\Users\\manas\\OneDrive\\Desktop\\nand2tetris\\projects\\06\\max";
		        try
		        {
		            obj1.input(path+"\\Max.asm");
		            System.out.println();
